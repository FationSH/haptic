...
double z = 0;          // position of the z
double lastz = 0;      // last position of the z
double vz = 0;         // velocity of the z
double lastVz = 0;     // last velocity of the z
double lastLastVz = 0; // last last velocity of the z
...
void loop(){
  ...
  // 2. Assign a motor output force in Newtons
